...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT '博客内容';

-- ----------------------------
-- Records of m_blog
-- ----------------------------
INSERT INTO `m_blog`
VALUES ('2', '1', '真正理解Mysql的四种隔离级别@',
        '事务是应用程序中一系列严密的操作，所有操作必须成功完成，否则在每个操作中所作的所有更改都会被撤消。也就是事务具有原子性，一个事务中的一系列的操作要么全部成功，要么一个都不做。\n\n事务的结束有两种，当事务中的所以步骤全部成功执行时，事务提交。如果其中一个步骤失败，将发生回滚操作，撤消撤消之前到事务开始时的所以操作 ',
        '2', now(), now(), '0', '0', '0', '0', '0');

INSERT INTO `m_blog_content`
VALUES ('2',
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT '文章阅读量表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='博客标签关系表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT '系统通知表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='用户通知关系表';
